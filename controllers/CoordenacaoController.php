...
class CoordenacaoController extends \yii\web\Controller
{
     ...
     * @param integer $id
     * @return Coordenacao the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id){
        if (($model = Coordenacao::findOne($id)) !== null) {
            return $model;
        } else {
