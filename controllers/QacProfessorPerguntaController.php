...
class QacProfessorPerguntaController extends \yii\web\Controller
{
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => QacProfessorPergunta::find(),
        ]);
     ...
     * @param integer $id
     * @return QacProfessorPergunta the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = QacProfessorPergunta::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    {
        $model = new QacProfessorPergunta();
