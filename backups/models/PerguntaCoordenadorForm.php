...
class PerguntaCoordenadorForm extends Model
{
    public $_parcels;
    ...
    public function getParcels()
    {
        if ($this->_parcels === null) {
            $this->_parcels = \app\models\PerguntaAvaliacaoCoordenador::find()->all();
        }
    ...
    {
        $parcel = $key && strpos($key, 'new') === false ? PerguntaAvaliacaoCoordenador::findOne($key) : false;
        if (!$parcel) {
            $parcel = new PerguntaAvaliacaoCoordenador();
    ...
    public function setParcels($parcels)
    {
        ...
        foreach ($parcels as $key => $parcel) {
            ...
            } elseif ($parcel instanceof PerguntaAvaliacaoCoordenador) {
