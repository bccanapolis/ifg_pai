...
<div class="disciplina-view">
    ...
    <p>
        ...
        <?= Html::a("Adicionar Alunos", ['aluno-disciplina/create', 'idDisciplina' => $model->id], ['class' => 'btn btn-warning']) ?>
        <?php
    ...
    <div class="row">
        ...
        $gridColumn = [
            ...
            'semestre',
            [
                'attribute' => 'professor.' . \app\models\Professor::representingColumn(),
                'label' => 'Id Professor',
            ],
        ];
        ...
        <?php $query = app\models\AlunoDisciplina::find()->where(['id_disciplina' => $model->id]);
