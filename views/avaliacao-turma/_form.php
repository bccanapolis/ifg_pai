...
<div class="aluno-form">
    ...
    echo Form::widget([
        ...
        'columns' => 12,
        'attributes' => [
            'nota' => ['type' => Form::INPUT_DROPDOWN_LIST, 'items' => \app\models\QacProfessor::$notas],
            ...
            'pergunta_id' => ['type' => Form::INPUT_DROPDOWN_LIST, 'items' => ArrayHelper::map(QacProfessorPergunta::find()->asArray()->orderBy(QacProfessorPergunta::representingColumn())->all(), 'id', QacProfessorPergunta::representingColumn()), 'columnOptions' => ['colspan' => 8], 'options' => ['placeholder' => 'Pergunta']],
