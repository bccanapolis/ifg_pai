...
?>
<div class="notas-disciplina-index">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Create Notas Disciplina', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
...
<?php 
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-notas-disciplina']],
        'panel' => [
